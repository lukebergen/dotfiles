...
commands.massOpen = function()
  local ticketText = hs.pasteboard.getContents()
  local tickets = ticketText:gmatch("[^\r\n]+")
  ...
  if (c > 10) then
    hs.alert("that's waaaaay too many browser tabs to open at once. 10 at a time is my max")
  else
    hs.eventtap.keyStroke("cmd", "l")
    for ticket in tickets do
      hs.eventtap.keyStrokes("https://massmutual.atlassian.net/browse/" .. ticket)

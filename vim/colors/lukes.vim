...
call s:h("StatusLineNC",  { "fg": s:dimwhite,   "bg": s:black,        "format": "reverse" })
...
call s:h("VertSplit",     { "fg": s:white, "bg": NONE })
...
call s:h("Todo",          { "fg": s:red, "bg": s:white,   "format": "bold,italic" })
call s:h("Comment",       { "fg": s:warmgrey})
"call s:h("Comment",       { "fg": s:darkred})
